...
# python main.py  -m 13043807040 -r 1 -d hdd
...
ori_image_hdfs_hdd = "hdfs:///user/gao/bigbrain_40microns.nii"
out_dir_hdfs_hdd = "hdfs:///user/gao/blocks125"

csv_file_hdfs_hdd = "hdfs:///user/gao/mwrites_hdfs_hdd.dat"
...
files = {
    "hdd": (ori_image_hdfs_hdd, out_dir_hdfs_hdd, csv_file_hdfs_hdd),
    "ssd": (ori_image_hdfs_ssd, out_dir_hdfs_ssd, csv_file_hdfs_ssd)
}
