...
# /user/gao/
client = InsecureClient("http://localhost:50070", user="amazin")
# Get the default alias' client. (See the quickstart sectzion in the
# documentation to learn more about this.)

data = np.arange(0,1000).tobytes()

client.write("/test", data=data,append=True)
